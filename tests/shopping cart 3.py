...
count_2_cart.click()
time.sleep(2)
close_2 = driver.find_element(By.CSS_SELECTOR, '.mhtspace-10>.box-inline.v-top.btn.btn-white.divider.pvspace-25.phspace-10.text-underline-none.radius-3.mvrspace-10')
close_2.click()
time.sleep(2)
...
count_3_cart.click()
time.sleep(2)
close_3 = driver.find_element(By.CSS_SELECTOR, '.mhtspace-10>.box-inline.v-top.btn.btn-white.divider.pvspace-25.phspace-10.text-underline-none.radius-3.mvrspace-10')
close_3.click()
time.sleep(2)
